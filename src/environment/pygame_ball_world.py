...
class BallWorld(object):
    def __init__(self, screen_size, num_balls, radius_range, world_id):
        pygame.init()
...
def generate_data(num_videos):
    for i in range(num_videos):
        bw = BallWorld(screen_size=args.screen_size, num_balls=args.num_balls, radius_range=args.radius_range, world_id=i)
